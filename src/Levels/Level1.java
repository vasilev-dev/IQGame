...
public class Level1 extends LevelBuilder {
    ...
    protected void createBalls(GameField field) {
        new Ball(new Position(10, 2), field, Color.GREEN);
        new Ball(new Position(12, 4), field, Color.RED);
        new Ball(new Position(7, 5), field, Color.BLUE);
        new Ball(new Position(9, 7), field, Color.YELLOW);
    }
