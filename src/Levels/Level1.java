...
public class Level1 extends LevelBuilder {
    ...
    public LevelBuilder createBalls() {
        new Ball(new Position(10, 2), _field, Color.GREEN);
        new Ball(new Position(12, 4), _field, Color.RED);
        new Ball(new Position(7, 5), _field, Color.BLUE);
        new Ball(new Position(9, 7), _field, Color.YELLOW);
